...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c7 = function(item) {
        return item;
      },
      peg$c8 = function(count, name) {
        return `${count} ${name}`;
      },
      peg$c9 = /^[0-9]/,
